...
export const useSocket = () => {
     ...
     */
    const onDocumentAnalyzed = useCallback((callback) => {
     ...
     */
    const onDocumentProcessingStarted = useCallback((callback) => {
        if (socketRef.current) {
     ...
     */
    const onDocumentProcessingCompleted = useCallback((callback) => {
        if (socketRef.current) {
     ...
     */
    const onDocumentProcessingError = useCallback((callback) => {
        if (socketRef.current) {
     ...
     */
    const onKanbanCardMoved = useCallback((callback) => {
        if (socketRef.current) {
     ...
     */
    const onKanbanCardCreated = useCallback((callback) => {
        if (socketRef.current) {
     ...
     */
    const onKanbanCardDeleted = useCallback((callback) => {
        if (socketRef.current) {
     ...
     */
    const onLeadStatusChanged = useCallback((callback) => {
        if (socketRef.current) {
     ...
     */
    const onLeadConverted = useCallback((callback) => {
        if (socketRef.current) {

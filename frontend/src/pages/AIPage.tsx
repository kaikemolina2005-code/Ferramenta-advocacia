      ...
      {!aiStatus?.configured && (
        <div className="bg-gradient-to-r from-blue-500/10 to-blue-500/5 rounded-xl border border-blue-500/20 p-6">
          ...
          <p className="text-gray-300 mb-4">
            Para habilitar processamento com IA, configure a chave OpenAI no arquivo{' '}
...
{`OPENAI_API_KEY="sk-your-api-key-here"`}
          ...
          <p className="text-sm text-gray-400 mt-4">
            ...
            <a href="https://platform.openai.com/api-keys" target="_blank" rel="noreferrer" className="text-blue-400">
